...
from controllers import BestTTSizeSearchController
...
class BestTTSizeSearchPage(Page):
    def __init__(self, width, height):
        ...
        self.controller = BestTTSizeSearchController(width, height)
    ...
    def __draw_control_window_elements(self):
        with dpg.window(label='Control', width=self.control_window_width, height=self.control_window_height, pos=(0, 0), tag='control_window'):
            ...
            dpg.add_input_int(label='Number of Bins', width=125, default_value=1, tag='method_input')
